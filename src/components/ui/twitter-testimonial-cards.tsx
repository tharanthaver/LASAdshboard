    ...
    const defaultCards: TestimonialCardProps[] = [
      {
        ...
        username: "Sarah Chen",
        handle: "@sarahchen",
        content: "LASA has completely transformed how I analyze market trends. The dashboard is incredibly intuitive and the machine learning insights are spot on! 🚀",
        date: "Jan 3, 2026",
        verified: true,
        likes: 124,
        retweets: 18,
      ...
      },
      {
        ...
        handle: "@mikej_dev",
        content: "The LASA dashboard is a masterpiece of UX design. I've never seen such high-quality market visualization tools in a web application. Exceptional work by the team! 💎",
        date: "Jan 2, 2026",
        verified: true,
        likes: 89,
        retweets: 12,
      ...
      },
      {
        ...
        handle: "@alexrivera",
        content: "Finally, a financial dashboard that is as powerful as it is beautiful. LASA is the future of retail trading analytics. Chef's kiss for the dark mode support! 👨‍🍳",
        date: "Jan 1, 2026",
        verified: true,
        likes: 256,
        retweets: 45,
